...
namespace PatientMedication.Infrastructure.Migrations
{
    ...
    [Migration("20250406201027_20250406-002-Add-MedicationRequest-table")]
    partial class _20250406002AddMedicationRequesttable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatientMedication.Infrastructure.Models.MedicationRequest", b =>
                {
                    b.Property<int>("MedicationRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MedicationRequestId"));
                    ...
                    b.Property<int>("FrequencyNumberOfTimes")
                        .HasColumnType("int");

                    b.Property<int>("FrequencyUnitId")
                        .HasColumnType("int");

                    b.Property<string>("MedicationReference")
                        .IsRequired()
                        .HasMaxLength(10)
                        .IsUnicode(false)
                        .HasColumnType("varchar(10)");
                    ...
                    b.HasKey("MedicationRequestId")
                        .HasName("PK_MedicationRequest");

                    b.HasIndex("ClinicianReference");

                    b.HasIndex("MedicationReference");

                    b.HasIndex("MedicationRequestStatusId");

                    b.HasIndex("PatientReference");

                    b.ToTable("MedicationRequest", "medication");
                });
            ...
            modelBuilder.Entity("PatientMedication.Infrastructure.Models.MedicationRequest", b =>
                {
                    b.HasOne("PatientMedication.Infrastructure.Models.Clinician", "Clinician")
                        .WithMany()
                        .HasForeignKey("ClinicianReference")
                        .HasPrincipalKey("ClinicianReference")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PatientMedication.Infrastructure.Models.Medication", "Medication")
                        .WithMany()
                        .HasForeignKey("MedicationReference")
                        .HasPrincipalKey("Code")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PatientMedication.Infrastructure.Models.MedicationRequestStatus", "Status")
                        .WithMany()
                        .HasForeignKey("MedicationRequestStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PatientMedication.Infrastructure.Models.Patient", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientReference")
                        .HasPrincipalKey("PatientReference")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
